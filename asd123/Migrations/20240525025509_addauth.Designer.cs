...
namespace asd123.Migrations
{
    ...
    [Migration("20240525025509_addauth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asd123.Model.UserRoleSchema", b =>
                {
                    ...
                    b.Property<int>("UserSchemaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("RoleSchemaId");
            ...
            modelBuilder.Entity("asd123.Model.UserRoleSchema", b =>
                {
                    b.HasOne("asd123.Model.RoleSchema", "RoleSchema")
                        .WithMany()
                        .HasForeignKey("RoleSchemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("asd123.Model.UserSchema", "UserSchema")
                        .WithMany()
                        .HasForeignKey("UserSchemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RoleSchema");
